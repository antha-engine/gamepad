...
export const VirApp = defineElement()({
    ...
    render({state, updateState}) {
        ...
        const gamepadDevices: ReadonlyArray<Readonly<GamepadDevice>> = [...state.gamepadDevices];
                ...
                <header>
                    <div class="column">
                        ...
                        <p>
                            ...
                            @antha/gamepad-type npm package.
                        </p>
                        <ul>
                            <li>
                                <a href="https://github.com/electrovir/antha">
                                    Repository in GitHub
                                </a>
                            </li>
                            <li>
                                <a href="https://www.npmjs.com/package/@antha/gamepad-type">
                                    Package on npm
                                </a>
                            </li>
                        </ul>
